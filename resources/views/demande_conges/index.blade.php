...
<script>
/**
 * INCHANGÉ — un seul champ commentaire qui change de label/style
 * selon favorable/défavorable. Corrige le bug des deux champs
 * name="commentaire" où le navigateur n'envoyait que le dernier.
 */
