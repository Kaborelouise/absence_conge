@extends('layouts.app')
@section('title', 'Modifier avis jouissance')
    ...
    <div class="col-md-7">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('avis_jouissances.update', $avis->id) }}"
                      method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('demande_jouissances.show', $avis->demande_jouissance_id) }}"
