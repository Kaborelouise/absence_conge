        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <table class="table table-sm">
                    ...
                    <tr><th>Nombre de jours</th><td>{{ $demande->nombre_jour }} jour(s)</td></tr>
                    <tr>
                        <th>Statut</th>
                        <td>
                ...
                {{-- Bouton donner avis selon statut --}}
                @if(!in_array($demande->statut, ['validee', 'rejetee']))
                    <a href="{{ route('avis_jouissances.create', ['demande_jouissance_id' => $demande->id]) }}"
                       class="btn btn-primary btn-sm mt-3">
                        <i class="bi bi-chat-square-text me-1"></i> Donner un avis
                    </a>
                @endif
            </div>
        </div>
                ...
                <div class="d-flex align-items-start gap-3 mb-3 pb-3 border-bottom">
                    ...
                    <div style="flex:1">
                        ...
                        {{-- <div class="mt-2 d-flex gap-2">
                            <a href="{{ route('avis_jouissances.edit', $avis->id) }}"
                               class="btn btn-outline-warning"
                               style="font-size:11px;padding:2px 8px">
                                <i class="bi bi-pencil"></i> Modifier
                            </a>
                            <form action="{{ route('avis_jouissances.destroy', $avis->id) }}"
