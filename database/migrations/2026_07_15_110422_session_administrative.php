...
{
    /**
     * Table pour les campagnes annuelles (sessions administratives) gérées par
     * l'admin/RH, qui regroupent les demandes d'absence, de congé et de
     * jouissance d'une même année/campagne.
     *
     * IMPORTANT : nommée "sessions_administratives" et NON "sessions", car ce
    ...
    {
        Schema::create('sessions_administratives', function (Blueprint $table) {
            $table->id();
            ...
            // Traçabilité : qui a ouvert cette session (admin ou agent_rh)
    ...
    {
        Schema::dropIfExists('sessions_administratives');
    }
};